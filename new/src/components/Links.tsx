        ...
        <div className='piccontainer'>
          ...
          <div>
            ...
            <ul>
              ...
              <li>
                <a className="banner-link" href="https://210o.net/" rel="colleague noreferrer" target="_blank">
                  <img src="/imgs/210on_banner_02-LosQT92u.png" alt="バナー" height="40" width="200" />
                  <span>ぱうろさん</span>
                </a>
              </li>
